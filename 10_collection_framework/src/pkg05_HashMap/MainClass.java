...
public class MainClass {
  ...
  public static void method1() {
    ...
    // HashMap 선언   value에는 숫자도 쓰고싶고 문자도 쓸 수 있으므로 Object를 제일 많이 씀
    ...
    // System.out.println(book.get("isBestSeller") ? "베스트셀러" : "일반서적"); 오류 -> object가 boolean은 아님 꺼낼때는 boolean으로 캐스팅 해줘야함.
