...
/*
 * Lambda Expression
 * 1. Anonymous Inner Type 객체를 생성할 떄 사용할 수 있는 새로운 표현식이다.
 ...
 *              본문
 *              }
 *    (2) A a = () -> 본문    // 본문 내용이 1개인 경우 중괄호 생략 가능
 * 
 * 2. 파라미터 X, 반환 O
 ...
 *                return 문자열
 *                }
 *    2) A a = () -> 문자열    // 본문 내용이 return 만 있는 경우 중괄호와 return 키워드 생략 가능
 * 
 * 3. 파라미터 O, 반환 X
